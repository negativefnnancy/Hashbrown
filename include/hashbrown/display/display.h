...
#define ELECTRONS_PER_SECOND 2400000
#define INTENSITY_PER_SECOND 50000.0
...
#define PHOSPHOR_EMITTANCE_BLUE  0.05
...
#define BLOOM_DIAMETER   3
#define BLOOM_SPREAD     100
#define BLOOM_BRIGHTNESS 30
